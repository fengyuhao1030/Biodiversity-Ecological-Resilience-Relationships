...
Fig <- ggplot()+
  ...
  theme_custom()
outputFileName <- 'Fig_e_High_Stable_State_1.pdf'
...
Fig <- ggplot()+
  ...
  scale_y_continuous(limits = c(-1.3,1.3),expand = c(0,0))+
  theme_custom()
outputFileName <- 'Fig_e_High_Stable_State_2.pdf'
pdf(file <- outputFileName,width = 0.8,height = 0.7)
print(Fig)
dev.off()
Fig <- ggplot()+
  ...
  scale_y_continuous(limits = c(-1.3,1.3),expand = c(0,0))+
  theme_custom()
outputFileName <- 'Fig_e_High_Stable_State_3.pdf'
pdf(file <- outputFileName,width = 0.8,height = 0.7)
print(Fig)
dev.off()
##==== High stable state ====##
...
Fig <- ggplot()+
  ...
  scale_y_continuous(limits = c(-1.3,1.3),expand = c(0,0))+
  theme_custom()
outputFileName <- 'Fig_e_Low_Stable_State_1.pdf'
pdf(file <- outputFileName,width = 0.8,height = 0.7)
print(Fig)
dev.off()
Fig <- ggplot()+
  ...
  scale_y_continuous(limits = c(-1.3,1.3),expand = c(0,0))+
  theme_custom()
outputFileName <- 'Fig_e_Low_Stable_State_2.pdf'
pdf(file <- outputFileName,width = 0.8,height = 0.7)
print(Fig)
dev.off()
Fig <- ggplot()+
  ...
  scale_y_continuous(limits = c(-1.3,1.3),expand = c(0,0))+
  theme_custom()
outputFileName <- 'Fig_e_Low_Stable_State_3.pdf'
pdf(file <- outputFileName,width = 0.8,height = 0.7)
print(Fig)
dev.off()
##==== Low stable state ====##
...
##==== Bistable states ====##
dataMatrix <- read.xlsx('Data.xlsx',sheet = 2)
...
Fig <- ggplot()+
  geom_line(data = drawMatrix_1,mapping = aes(x = Env,y = EcoState),color = '#f2a319',linewidth = 0.7)+
  geom_line(data = drawMatrix_3,mapping = aes(x = Env,y = EcoState),color = '#58b038',linewidth = 0.7)+
  scale_x_continuous(limits = c(-4.5,4.5),expand = c(0,0))+
  scale_y_continuous(limits = c(-3.8,3.8),expand = c(0,0))+
  theme_custom()
outputFileName <- 'Fig_e_Bistable_State_1.pdf'
pdf(file <- outputFileName,width = 0.8,height = 0.7)
print(Fig)
dev.off()
env <- seq(-1,1,length.out = 100)
...
Fig <- ggplot()+
  ...
  scale_y_continuous(limits = c(-1.3,1.3),expand = c(0,0))+
  theme_custom()
outputFileName <- 'Fig_e_Bistable_State_2.pdf'
pdf(file <- outputFileName,width = 0.8,height = 0.7)
print(Fig)
dev.off()
Fig <- ggplot()+
  ...
  scale_y_continuous(limits = c(-1.3,1.3),expand = c(0,0))+
  theme_custom()
outputFileName <- 'Fig_e_Bistable_State_3.pdf'
pdf(file <- outputFileName,width = 0.8,height = 0.7)
print(Fig)
dev.off()
env <- seq(-1,1,length.out = 100)
...
Fig <- ggplot()+
  ...
  scale_y_continuous(limits = c(-1.3,1.3),expand = c(0,0))+
  theme_custom()
outputFileName <- 'Fig_e_Bistable_State_4.pdf'
pdf(file <- outputFileName,width = 0.8,height = 0.7)
print(Fig)
dev.off()
Fig <- ggplot()+
  ...
  scale_y_continuous(limits = c(-1.3,1.3),expand = c(0,0))+
  theme_custom()
outputFileName <- 'Fig_e_Bistable_State_5.pdf'
pdf(file <- outputFileName,width = 0.8,height = 0.7)
print(Fig)
dev.off()
##==== Bistable states ====##